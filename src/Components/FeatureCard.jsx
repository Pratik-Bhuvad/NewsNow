...
const FeatureCard = ({ feature }) => {
    ...
    return (
        <article className='w-4/5 flex flex-col items-center gap-y-2 rounded-lg py-5 px-2 shadow-xl transition-all duration-300 ease-in-out bg-bglight dark:bg-bgdark dark:shadow-black/50 hover:-translate-y-5'>
